...
window.I18N = (function () {
  ...
  var DICT = {
    tr: {
      ...
      "date.any": "Tüm tarihler",
      "date.today": "Bugün",
      "date.tomorrow": "Yarın",
      "date.weekend": "Hafta sonu",
      "date.pick": "Tarih seç",
      "date.clear": "Tarihi temizle",
      "discover.emptyOnDate": "{date} için etkinlik yok",
      "discover.emptyOnDateBody": "Başka bir tarihe bak ya da tarih filtresini temizle.",
      "filter.all": "Tümü",
      ...
      "detail.cancelSeries": "Tüm seriyi iptal et",
      "detail.otherDates": "Serideki diğer tarihler",
      "detail.otherDatesBody": "Her tarih ayrı bir etkinlik — istediğine ayrı ayrı katılabilirsin.",
      "detail.occurrenceFull": "Dolu",
      "detail.occurrenceLeft_one": "{count} yer kaldı",
      "detail.occurrenceLeft_other": "{count} yer kaldı",
      "badge.repeat_one": "Tekrarlayan · {count} tarih",
      "badge.repeat_other": "Tekrarlayan · {count} tarih",
      ...
      "create.repeat": "Tekrar",
      "create.repeatCount": "Kaç kez",
      "repeat.none": "Tekrar etmesin",
      "repeat.weekly": "Her hafta",
      "repeat.biweekly": "İki haftada bir",
      "repeat.monthly": "Her ay",
      "create.repeatPreview_one": "{count} etkinlik oluşturulacak: {first}",
      "create.repeatPreview_other": "{count} etkinlik oluşturulacak: {first} — {last}",
      "create.repeatHint": "Her tekrar ayrı bir etkinliktir: kendi kontenjanı, katılımcı listesi ve bileti olur.",
      "create.payoutNote":
      ...
      "payouts.title": "Ödeme hesabım",
      "payouts.intro": "Düzenlediğin etkinliklerin ücretini doğrudan kendi banka hesabına almak için Stripe hesabını bağla.",
      "payouts.statusNone": "Bağlı değil",
      "payouts.statusPending": "Kurulum yarım kaldı",
      "payouts.statusActive": "Aktif",
      "payouts.connect": "Ödeme hesabı bağla",
      "payouts.continue": "Kuruluma devam et",
      "payouts.manage": "Stripe panelimi aç",
      "payouts.refresh": "Durumu yenile",
      "payouts.opening": "Açılıyor…",
      "payouts.readyNote": "Katılım ücretinin %{percent}'i ödeme anında doğrudan sana geçiyor; kalanı platform komisyonu.",
      "payouts.notReadyNote": "Hesabın bağlı olmadığı sürece ücretler {owner} hesabında toplanır ve sana elle aktarılır.",
      "payouts.demoNote": "Demo modunda gerçek Stripe ekranı açılmaz; hesap anında aktif sayılır.",
      "payouts.disabledNote": "Otomatik ödeme bu kurulumda kapalı.",
      "payouts.refreshed": "Ödeme hesabı durumu güncellendi.",
      "create.payoutAuto": "Katılım ücretinin %{percent}'i ödeme anında doğrudan senin hesabına geçer; kalanı platform komisyonudur.",
      "create.payoutWarning": "Ödeme hesabın bağlı değil. Ücretli etkinlik açabilirsin ama ücretler {owner} hesabında toplanır ve sana elle aktarılır. Profilinden bağlayabilirsin.",

      "owner.autoPaid": "Otomatik ödenen",
      "owner.manualOwed": "Elle ödenecek",
      "owner.colPayout": "Dağıtım",
      "payout.connect": "Otomatik",
      "payout.platform": "Elle",
      ...
      "auth.forgotSub": "E-posta adresini gir, sana bir sıfırlama bağlantısı gönderelim.",
      "auth.forgotSend": "Bağlantı gönder",
      "auth.forgotSent": "Bu adres kayıtlıysa sıfırlama bağlantısı gönderildi. Gelen kutunu kontrol et.",
      "auth.resetTitle": "Yeni şifre belirle",
      "auth.resetSub": "Hesabın için yeni bir şifre seç.",
      "auth.newPassword": "Yeni şifre",
      "auth.resetSubmit": "Şifreyi güncelle",
      "auth.resetDone": "Şifren güncellendi, şimdi giriş yapabilirsin.",
      "auth.backToLogin": "Girişe dön",

      "danger.title": "Hesabımı sil",
      "danger.intro": "Hesabını kalıcı olarak silersin. Yaklaşan etkinliklerdeki yerin bırakılır ve ödemelerin iade edilir.",
      "danger.keepsRecords": "Ödeme geçmişin varsa muhasebe kayıtları saklanır ama kişisel bilgilerin silinir.",
      "danger.passwordPrompt": "Onaylamak için şifreni gir",
      "danger.delete": "Hesabımı kalıcı olarak sil",
      "danger.deleting": "Siliniyor…",
      "danger.confirm": "Hesabın kalıcı olarak silinecek. Emin misin?",
      "danger.done": "Hesabın silindi.",
      ...
      "confirm.cancelSeries_one": "Serinin kalan {count} tarihi iptal edilecek ve ödeyen herkese iade yapılacak. Devam edilsin mi?",
      "confirm.cancelSeries_other": "Serinin kalan {count} tarihi iptal edilecek ve ödeyen herkese iade yapılacak. Devam edilsin mi?",
      ...
      "toast.seriesPublished_one": "{count} etkinlik yayında 🎉",
      "toast.seriesPublished_other": "{count} etkinlik yayında 🎉",
      "toast.seriesCancelled_one": "{count} etkinlik iptal edildi.",
      "toast.seriesCancelled_other": "{count} etkinlik iptal edildi.",
    ...
    en: {
      ...
      "discover.emptyOnDate": "Nothing on {date}",
      "discover.emptyOnDateBody": "Try another date, or clear the date filter.",
      "filter.all": "All",
      ...
      "detail.cancelSeries": "Cancel the whole series",
      "detail.otherDates": "Other dates in this series",
      "detail.otherDatesBody": "Each date is a separate event — join whichever ones you want.",
      "detail.occurrenceFull": "Full",
      "detail.occurrenceLeft_one": "{count} spot left",
      "detail.occurrenceLeft_other": "{count} spots left",
      "badge.repeat_one": "Repeats · {count} date",
      "badge.repeat_other": "Repeats · {count} dates",
      ...
      "create.repeatCount": "How many",
      "repeat.none": "Does not repeat",
      "repeat.weekly": "Every week",
      "repeat.biweekly": "Every two weeks",
      "repeat.monthly": "Every month",
      "create.repeatPreview_one": "{count} event will be created: {first}",
      "create.repeatPreview_other": "{count} events will be created: {first} — {last}",
      "create.repeatHint": "Each repeat is its own event, with its own capacity, attendee list and tickets.",
      "create.payoutNote":
      ...
      "payouts.title": "My payout account",
      "payouts.intro": "Connect your Stripe account to receive the fees from events you host straight to your bank.",
      "payouts.statusNone": "Not connected",
      "payouts.statusPending": "Setup incomplete",
      "payouts.statusActive": "Active",
      "payouts.connect": "Set up payouts",
      "payouts.continue": "Continue setup",
      "payouts.manage": "Open my Stripe dashboard",
      "payouts.refresh": "Refresh status",
      "payouts.opening": "Opening…",
      "payouts.readyNote": "{percent}% of each ticket goes straight to you at the moment of payment; the rest is the platform commission.",
      "payouts.notReadyNote": "Until your account is connected, fees are collected by {owner} and transferred to you manually.",
      "payouts.demoNote": "In demo mode no real Stripe screen opens; the account is treated as active right away.",
      "payouts.disabledNote": "Automatic payouts are switched off in this setup.",
      "payouts.refreshed": "Payout account status updated.",
      "create.payoutAuto": "{percent}% of each ticket lands in your own account at the moment of payment; the rest is the platform commission.",
      "create.payoutWarning": "Your payout account is not connected. You can still charge for this event, but the fees will be collected by {owner} and transferred to you manually. You can connect it from your profile.",

      "owner.autoPaid": "Paid automatically",
      "owner.manualOwed": "Owed manually",
      "owner.colPayout": "Split",
      "payout.connect": "Auto",
      "payout.platform": "Manual",
      ...
      "auth.forgotSent": "If that address is registered, a reset link is on its way. Check your inbox.",
      ...
      "auth.resetDone": "Your password is updated — you can sign in now.",
      "auth.backToLogin": "Back to sign in",

      "danger.title": "Delete my account",
      "danger.intro": "This permanently deletes your account. Your spots at upcoming events are given up and those payments are refunded.",
      "danger.keepsRecords": "If you have payment history, the accounting records are kept but your personal details are removed.",
      "danger.passwordPrompt": "Enter your password to confirm",
      "danger.delete": "Permanently delete my account",
      "danger.deleting": "Deleting…",
      "danger.confirm": "Your account will be permanently deleted. Are you sure?",
      "danger.done": "Your account has been deleted.",
      ...
      "confirm.cancelSeries_one": "The {count} remaining date in this series will be cancelled and everyone who paid will be refunded. Continue?",
      "confirm.cancelSeries_other": "The {count} remaining dates in this series will be cancelled and everyone who paid will be refunded. Continue?",
      ...
      "toast.seriesPublished_one": "{count} event is live 🎉",
      "toast.seriesPublished_other": "{count} events are live 🎉",
      "toast.seriesCancelled_one": "{count} event cancelled.",
      "toast.seriesCancelled_other": "{count} events cancelled.",
